    ...
    public partial class Signups : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               String query = "insert into Register values (@Name,@FatherName ,@MotherName ,@DateOfBirth ,@Gender, @Department,@MobileNo ,@Email ,@PermanenetAddress ,@State,@City ,@Pincode ,@Password,@Enroll) ";
